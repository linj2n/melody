...
public class TagServiceTest {
    ...
    public void prepareDataForTest() {
        Post newPost1 = new Post("TestPost1","Hello, I'm a testcase1.","DRAFT","/test1",99999L);
        Post newPost2 = new Post("TestPost2","Hello, I'm a testcase2.","DRAFT","/test2",9999L);
        Post newPost3 = new Post("TestPost3","Hello, I'm a testcase3.","DRAFT","/test3",999L);
        Post newPost4 = new Post("TestPost4","Hello, I'm a testcase4.","DRAFT","/test4",99L);
    ...
    public void test_removeTag() {
        ...
        postService.listPosts().stream().peek(post -> {
